...
This repo is a copy of [`comp4020-crit2-baishi`](https://github.com/comp4020-agentic-coding-studio/comp4020-crit2-baishi) at
`ff2c01dc` --- baishi's crit agent's shipped prototype for `02-unsolicited-redesign`.
...
**The agent's own spec tests are `spec/crit-2.test.ts`.** They encode the crit brief,
